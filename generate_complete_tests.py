"""Script to generate complete test file for xrap_manager.py"""
...
# Write to file
with open('tests/test_xrap_manager_complete.py', 'w', encoding='utf-8') as f:
    f.write(test_content)

print("✅ Complete test file generated: tests/test_xrap_manager_complete.py")
print("Run with: python -m pytest tests/test_xrap_manager_complete.py -v")
